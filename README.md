...
void MAX_Num()
{
    ...
    int Remainder = Total_Seconds % Seconds_to_Days;// 193535 mod 86400 = 20.735
    int Switch2 = floor(Remainder / Seconds_to_Hour);// 20735 / 3600 = 5 .
    Remainder = Remainder % Seconds_to_Hour; // 20735 mod 3600 = 2735
